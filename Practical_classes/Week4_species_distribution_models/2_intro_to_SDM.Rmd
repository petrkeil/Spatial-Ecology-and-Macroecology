...
- R-related overview of the different modelling approaches in [dismo package](https://cran.r-project.org/web/packages/dismo/vignettes/sdm.pdf).
- Damaris Zurell's tutorial.
- Comprehensive SDM class with videos and such.
...
# The actuall modelling

**Presence-only methods** 

**Presence-pseudo absence methods**
...
```{r}
library(dismo)
mx <- dismo::maxent(x = PO.predictors, p = PTS)
```
