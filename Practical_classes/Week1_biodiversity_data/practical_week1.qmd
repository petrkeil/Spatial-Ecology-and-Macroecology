...
![](https://observation.org/static/img/logo/logo-observation-org.svg){.centre top="200" height="100"}
...
![](https://ars.els-cdn.com/content/image/1-s2.0-S2352340917301981-gr1.jpg){.centre top="200" width="100"}
...
![](https://www.bto.org/sites/all/themes/egret/img/logo/bbs-logo-square.png){.centre top="300" height="300"}
...
::: incremental
-   Download the [Quarto](https://quarto.org) Markdown document for today's practical from: [practical_week1_exercise2_STUDENTS_FILE.qmd](https://github.com/petrkeil/Spatial-Ecology-and-Macroecology/blob/3713ec0823ba08d540f3aeea5f8d1a0acb56c71b/Practical_classes/Week1_biodiversity_data/practical_week1_exercise2_STUDENTS_FILE.qmd)
:::
...
::: {.fragment}
After this initial exploration, we are ready to download data. [Whoop!]{.font-big}\
:::
...
::: {.fragment}
[Note the use of `|` (OR) to filter the data. An alternative is `filter(basisOfRecord %in% c("PRESERVED_SPECIMEN","HUMAN_OBSERVATION"))`.]{.font-aside}
:::
