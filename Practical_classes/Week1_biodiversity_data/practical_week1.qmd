...
# [EXERCISE]{.story} [Explore different data sources and find out..]{style="float:right;text-align:right;"} {background-color="#5F9747"}
...
![](https://upload.wikimedia.org/wikipedia/commons/6/65/To_deposit_or_not_to_deposit%252C_that_is_the_question_-_journal.pbio.1001779.g001.png){.absolute bottom="50" left="100" width="544" height="418"}
