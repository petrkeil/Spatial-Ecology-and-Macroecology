...
date: 2022-10-10
author: 'Florencia Grattarola, Friederike Woelke & Gabriel Ortega'
...
![](https://chelsa-climate.org/wp-content/uploads/2016/02/logotest3.gif){.centre top="200" height="200"} [chelsa-climate.org](https://chelsa-climate.org)
...
levels(land[[1]]) <- data.frame(
  ID = c(1, 2, 3, 11, 12, 13, 14, 15, 16, 21, 22, 31, 32, 41, 42, 43),
  label = c(
    "Barren",
